    ...
    \label{sub:sparse_matrix_methoden}
      ...
      \label{ssub:cg-method}
        ...
        \begin{center}
          ...
          \end{tcolorbox}
        \end{center}
        In Abschnitt \ref{sub:time-step-computation} ist das hier beschriebene CG-Verfahren in der Sprache C++ auf CPU und auf der GPU unter Zuhilfenahme der Sprache CUDA, der Bibliothek \enquote{Eigen} und der Bibliothek \enquote{Thrust} implementiert worden \cite{cuda2018,Eigen2018}.
